...
class Blocks {
  ...
  function nectar_editor_assets() {
    ...
    if( $should_load_assets ) {
      ...
      wp_enqueue_script( 'gsap-js', NECTAR_BLOCKS_PLUGIN_PATH . '/assets/gsap/gsap.min.js', [], '3.12.5', true );
      wp_enqueue_script( 'gsap-scroll-trigger-js', NECTAR_BLOCKS_PLUGIN_PATH . '/assets/gsap/ScrollTrigger.min.js', ['gsap-js'], '3.12.5', true );
      wp_enqueue_script( 'gsap-custom-ease-js', NECTAR_BLOCKS_PLUGIN_PATH . '/assets/gsap/CustomEase.min.js', ['gsap-js'], '3.12.5', true );
