...
class MW_Post_Type {
	...
	/**
	 * Whether this post type is managed by MusicalWheel
	 *
	 * @var bool
	 */
	...
	public function __construct( $post_type, $repository = null ) {
		...
		// Check if managed by MusicalWheel
	...
	/**
	 * Check if post type is managed by MusicalWheel
	 *
	 * @return bool
	 */
	...
	public static function register( $args, $enable_graphql = true ) {
		...
		// Mark as managed by MusicalWheel
	...
	/**
	 * Get all MusicalWheel-managed post types
	 *
