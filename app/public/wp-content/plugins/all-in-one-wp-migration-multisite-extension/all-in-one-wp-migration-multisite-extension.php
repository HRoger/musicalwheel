...
register_activation_hook( __FILE__, 'ai1wmme_activate_plugin' );
 ...
 * @return void
 */
function ai1wmme_activate_plugin() {
	// Check if the base plugin is installed
	if ( ! ai1wmme_is_base_plugin_installed() ) {
		// Install the base plugin
		$install_result = ai1wmme_install_base_plugin();
		...
		if ( is_wp_error( $install_result ) ) {
			...
			wp_die(
				sprintf(
					__( 'The All-in-One WP Migration plugin could not be installed automatically. Please <a href="%s" target="_blank">download and install it manually</a> before activating this extension.', AI1WMME_PLUGIN_NAME ),
	...
	if ( ! ai1wmme_is_base_plugin_active() ) {
		...
		if ( is_wp_error( $activate_result ) ) {
			...
			wp_die(
				sprintf(
					__( 'The All-in-One WP Migration plugin could not be activated automatically. Please <a href="%s">activate it manually</a> before activating this extension.', AI1WMME_PLUGIN_NAME ),
