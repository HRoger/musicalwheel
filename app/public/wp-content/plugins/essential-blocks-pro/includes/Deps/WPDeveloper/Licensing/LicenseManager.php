...
namespace EssentialBlocks\Pro\Deps\WPDeveloper\Licensing;
...
class LicenseManager {
	...
	public function admin_notices() {
		...
		if ( ! empty( $this->error ) ) {
			$notice = sprintf( '<div style="padding: 10px;" class="%1$s-notice wpdeveloper-licensing-notice notice notice-error is-dismissible">%2$s</div>', $this->textdomain, $this->error['message'] );
		...
		$notice = sprintf( '<div style="padding: 10px;" class="%1$s-notice wpdeveloper-licensing-notice notice notice-error is-dismissible">%2$s</div>', $this->textdomain, $message );
