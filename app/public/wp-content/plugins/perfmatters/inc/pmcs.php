				...
				echo '<div style="display: flex; gap: 15px;">';
					...
					echo '<div>';
						...
						echo '<select id="pmcs-location-options" class="hidden" disabled>';
							...
							//js+css
							echo '<option value="wp_head" data-code-type="js,css"' . (!empty($snippet['location']) && $snippet['location'] == 'wp_head' ? ' selected' : '') . '>' . esc_html__('Frontend Header', 'perfmatters') . '</option>';
							echo '<option value="wp_footer" data-code-type="js"' . (!empty($snippet['location']) && $snippet['location'] == 'wp_footer' ? ' selected' : '') . '>' . esc_html__('Frontend Footer', 'perfmatters') . '</option>';
							...
							echo '<option value="admin_footer" data-code-type="js"' . (!empty($snippet['location']) && $snippet['location'] == 'admin_footer' ? ' selected' : '') . '>' . esc_html__('Admin Footer', 'perfmatters') . '</option>';

							//html
							echo '<option value="wp_head" data-code-type="html"' . (!empty($snippet['location']) && $snippet['location'] == 'header' ? ' selected' : '') . '>' . esc_html__('Frontend Header', 'perfmatters') . '</option>';
							echo '<option value="wp_body_open" data-code-type="html"' . (!empty($snippet['location']) && $snippet['location'] == 'body' ? ' selected' : '') . '>' . esc_html__('Frontend Body', 'perfmatters') . '</option>';
							echo '<option value="wp_footer" data-code-type="html"' . (!empty($snippet['location']) && $snippet['location'] == 'footer' ? ' selected' : '') . '>' . esc_html__('Frontend Footer', 'perfmatters') . '</option>';
