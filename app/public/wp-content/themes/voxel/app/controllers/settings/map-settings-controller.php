...
class Map_Settings_Controller extends \Voxel\Controllers\Base_Controller {
	...
	protected function register_settings( $settings ) {
		...
		'openstreetmap' => Schema::Object( [
			'tile_url' => Schema::String()->default('https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png'),
			'tile_subdomains' => Schema::String()->default('abc'),
			'geocoding_provider' => Schema::Enum( [
				'nominatim',
				'google_maps',
				'mapbox',
			] )->default('nominatim'),
			'nominatim' => Schema::Object( [
				'language' => Schema::String()->default(''),
				'countries' => Schema::List()
					->validator('is_string')
					->default([]),
