...
$blog_standard_type = 'featured_img_left';
...
if ($masonry_class !== null) {
    $masonry_style = 'auto_meta_overlaid_spaced';
...
if( has_action('nectar_blog_loop_post_item') ) {
    $masonry_class = $masonry_style = $std_minimal_class = $auto_masonry_spacing = '';
}
