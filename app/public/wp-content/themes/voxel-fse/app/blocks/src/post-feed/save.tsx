...
function createSaveFn(includePlaceholder: boolean) {
	return function save({ attributes }: SaveProps): JSX.Element {
		...
		const vxConfig: PostFeedVxConfig = {
			...
			skeletonBackgroundColor: attributes.skeletonBackgroundColor,
			skeletonBackgroundType: attributes.skeletonBackgroundType,
			skeletonBackgroundImage: attributes.skeletonBackgroundImage,
			skeletonBgImagePosition: attributes.skeletonBgImagePosition,
			skeletonBgImageAttachment: attributes.skeletonBgImageAttachment,
			skeletonBgImageRepeat: attributes.skeletonBgImageRepeat,
			skeletonBgImageSize: attributes.skeletonBgImageSize,
			skeletonGradientColor: attributes.skeletonGradientColor,
			skeletonGradientLocation: attributes.skeletonGradientLocation,
			skeletonGradientSecondColor: attributes.skeletonGradientSecondColor,
			skeletonGradientSecondLocation: attributes.skeletonGradientSecondLocation,
			skeletonGradientType: attributes.skeletonGradientType,
			skeletonGradientAngle: attributes.skeletonGradientAngle,
			skeletonGradientPosition: attributes.skeletonGradientPosition,
			icons: {
