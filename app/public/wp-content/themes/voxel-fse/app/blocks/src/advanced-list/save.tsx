	...
	return function save({ attributes }: SaveProps) {
		...
		const vxConfig: VxConfig = {
			...
			list: {
				...
				itemGap: attributes.itemGap !== undefined ? attributes.itemGap : d.itemGap,
				itemGapUnit: attributes.itemGapUnit ?? d.itemGapUnit,
			},
			itemStyle: {
				justifyContent: attributes.itemJustifyContent !== undefined ? attributes.itemJustifyContent : d.itemJustifyContent,
				padding: attributes.itemPadding ?? d.itemPadding,
				paddingUnit: attributes.itemPaddingUnit ?? d.itemPaddingUnit,
				height: attributes.itemHeight !== undefined ? attributes.itemHeight : d.itemHeight,
				...
				borderRadius: attributes.itemBorderRadius !== undefined ? attributes.itemBorderRadius : d.itemBorderRadius,
