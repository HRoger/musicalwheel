...
export default function SearchFormComponent( {
			...
			{ includeSubmit && attributes.showSearchButton && (
				...
				>
					...
					>
						...
						{ VoxelIcons.search }
						{ renderedSearchButtonText || 'Search' }
					</button>
				</div>
			) }
	...
	return (
		...
		<div className="ts-form ts-search-widget" data-v-app="">
			...
			{ showToggleButton && (
				<div className="ts-filter-wrapper flexify vx-hidden-desktop">
					<a
						href="#"
						onClick={ ( e ) => {
							e.preventDefault();
		...
		{ state.portalActive && createPortal(
			<div className="ts-search-portal vx-popup elementor">
