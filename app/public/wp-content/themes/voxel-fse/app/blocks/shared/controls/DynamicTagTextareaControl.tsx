/**
 * Dynamic Tag Textarea Control Component
 *
 * Matches Elementor/Voxel's inline dynamic tag pattern for textarea controls:
 * - Shows "Enable Voxel tags" button when no tags present
 * - Shows textarea with "EDIT TAGS" and "DISABLE TAGS" buttons when tags active
...
interface DynamicTagTextareaControlProps {
	label: string;
	value: string;
...
export default function DynamicTagTextareaControl({
	label,
	value,
	onChange,
	placeholder,
	...
	rows = 4,
	context = 'post',
}: DynamicTagTextareaControlProps) {
	...
	return (
		<div className="voxel-dynamic-tag-textarea-control elementor-control elementor-control-type-textarea" style={{ marginBottom: '16px' }}>
			...
			{/* Textarea input or tag preview panel */}
