...
class Dynamic_Tag extends Token {
	...
	public function render(): string {
		...
		// Phase 3.1: Resolve property via group
		$value = $this->group->resolve_property( $this->property_path, $this );

		// Ensure we have a string value before applying modifiers
		if ( is_array( $value ) ) {
			$value = implode( '', $value );
	...
	protected function _render_raw_tag(): string {
